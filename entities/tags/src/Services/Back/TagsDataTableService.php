...
use InetStudio\SocialContest\Tags\Contracts\Services\Back\TagsDataTableServiceContract;
...
class TagsDataTableService extends DataTable implements TagsDataTableServiceContract
{
    ...
    {
        $transformer = app()->make('InetStudio\SocialContest\Tags\Contracts\Transformers\Back\TagTransformerContract');
    ...
    {
        return [
            'url' => route('back.social-contest.tags.data.index'),
            'type' => 'POST',
        ];
    }
