    ...
    public function __construct($resource, string $type = '')
    {
        ...
        if ($type == 'autocomplete') {
            $itemResource = app()->make(
                'InetStudio\SocialContest\Statuses\Contracts\Http\Resources\Back\Utility\Suggestions\AutocompleteItemResourceContract',
                [
                    'resource' => null,
                ]
            );
            ...
            $itemResource = app()->make(
                'InetStudio\SocialContest\Statuses\Contracts\Http\Resources\Back\Utility\Suggestions\ItemResourceContract',
                [
                    'resource' => null,
                ]
            );
