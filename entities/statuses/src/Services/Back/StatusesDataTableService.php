...
use InetStudio\SocialContest\Statuses\Contracts\Services\Back\StatusesDataTableServiceContract;
...
class StatusesDataTableService extends DataTable implements StatusesDataTableServiceContract
{
    ...
    /**
     * StatusesDataTableService constructor.
     *
    ...
    {
        $transformer = app()->make('InetStudio\SocialContest\Statuses\Contracts\Transformers\Back\StatusTransformerContract');
