...
@section('content')
    ...
    <div class="row m-sm">
        <a class="btn btn-white" href="{{ route('back.social-contest.prizes.index') }}">
    ...
    <div class="wrapper wrapper-content">
        ...
        {!! Form::info() !!}
            ...
            {!! Form::open(['url' => (! $item->id) ? route('back.social-contest.prizes.store') : route('back.social-contest.prizes.update', [$item->id]), 'id' => 'mainForm', 'enctype' => 'multipart/form-data', 'class' => 'form-horizontal']) !!}
